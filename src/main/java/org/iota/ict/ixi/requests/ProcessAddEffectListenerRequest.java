...
public class ProcessAddEffectListenerRequest extends AbstractRequest {

    public ProcessAddEffectListenerRequest(Wrapper.WrapperMessage request, Client clientHandler) {
