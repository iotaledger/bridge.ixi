...
public class ProcessSubmitTransactionRequest extends AbstractRequest {

    public ProcessSubmitTransactionRequest(Wrapper.WrapperMessage request, Client clientHandler) {
