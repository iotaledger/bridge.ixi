...
public class ProcessDetermineApprovalConfidenceRequest extends AbstractRequest {

    public ProcessDetermineApprovalConfidenceRequest(Wrapper.WrapperMessage request, Client clientHandler) {
